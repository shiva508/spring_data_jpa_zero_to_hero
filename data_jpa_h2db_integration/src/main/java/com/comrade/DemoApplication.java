...
import com.comrade.dependancyInjection.BinarySearchImpl;
import com.comrade.dependancyInjectionBeansAutoWiring.ServiceBeanByName;
import com.comrade.dependancyInjectionBeansAutoWiring.ServiceBeanByType;
import com.comrade.dependancyInjectionBeansAutoWiring.ServiceBeanNo;
import com.comrade.dependancyInjectionCONFIGURATION.Client;
import com.comrade.dependancyInjectionCONFIGURATION.DiConfig;
import com.comrade.dependancyInjectionIMPORT.DiConfigImport;
import com.comrade.dependancyInjectionRESOURCE.ProductService;
import com.comrade.dependancyInjectionbean.OrderService;
import com.comrade.findById.PersonFindByIdService;
import com.comrade.model.Department;
import com.comrade.model.Employee;
import com.comrade.model.Person;
import com.comrade.model.PersonFindById;
import com.comrade.model.Phone;
import com.comrade.model.Professor;
import com.comrade.model.Role;
import com.comrade.model.RoleJdbc;
import com.comrade.model.Student;
import com.comrade.model.User;
import com.comrade.model.UserJdbc;
import com.comrade.model.BLOB.ProductBLOB;
import com.comrade.model.CLOB.ProductCLOB;
import com.comrade.model.EMBEDDEDandEMBEDDABLE.Address;
import com.comrade.model.EMBEDDEDandEMBEDDABLE.UserName;
import com.comrade.model.EMBEDDEDandEMBEDDABLE.UserPhoneNumber;
import com.comrade.model.EMBEDDEDandEMBEDDABLE.UserProfile;
import com.comrade.model.ENUM.Project;
import com.comrade.model.ENUM.ProjectStatus;
import com.comrade.model.ENUM.ATTRIBUTECONVERTER.Caption;
import com.comrade.model.ENUM.ATTRIBUTECONVERTER.Gender;
import com.comrade.model.ENUM.ATTRIBUTECONVERTER.PersonENUM;
import com.comrade.model.ENUM.ATTRIBUTECONVERTER.Photo;
import com.comrade.model.EXTRALAZYCOLLECTIONS.ExtraLazyPostRepository;
import com.comrade.model.HASHCODEANDEQUALS.Company;
import com.comrade.model.HASHCODEANDEQUALS.EAGER.Image;
import com.comrade.model.HASHCODEANDEQUALS.EAGER.ProductEager;
import com.comrade.model.SYNCHRONIZEBIDIRECTIONALENTITY.ManyToMany.Tag;
import com.comrade.model.SYNCHRONIZEBIDIRECTIONALENTITY.OneToMany.Post;

import com.comrade.model.SYNCHRONIZEBIDIRECTIONALENTITY.OneToMany.PostComment;
import com.comrade.model.SYNCHRONIZEBIDIRECTIONALENTITY.OneToOne.PostDetails;
import com.comrade.model.UUID.BookUUID;
import com.comrade.model.naturalid.Product;
import com.comrade.model.onetomany.RoleR;
import com.comrade.modelElementCollection.Customer;
import com.comrade.modelElementCollection.CustomerRepository;
import com.comrade.modelElementCollectionEmbeddable.CustomerOne;
import com.comrade.modelElementCollectionEmbeddable.CustomerOneRepository;
import com.comrade.modelElementCollectionEmbeddable.PhoneNumberOne;
import com.comrade.modelElementCollectionEmbeddable.PhoneType;
import com.comrade.repository.DepartmentRepository;
import com.comrade.repository.EmployeeRepository;
import com.comrade.repository.PersonRepository;
import com.comrade.repository.ProfessorPhoneAccessType;
import com.comrade.repository.ProfessorPhoneAccessTypeRepository;
import com.comrade.repository.ProfessorRepository;
import com.comrade.repository.RoleJdbcRepository;
import com.comrade.repository.RoleRRepository;
import com.comrade.repository.RoleRepository;
import com.comrade.repository.StudentRepository;
import com.comrade.repository.UserJdbcRepository;
import com.comrade.repository.UserRRepository;
import com.comrade.repository.UserRepository;
import com.comrade.repository.BLOB.ProductBLOBRepository;
import com.comrade.repository.CLOB.ProductCLOBRepository;
import com.comrade.repository.HASHCODEANDEQUALS.CompanyRepository;
import com.comrade.repository.HASHCODEANDEQUALS.EAGER.ProductEagerRepository;
import com.comrade.repository.SYNCHRONIZEBIDIRECTIONALENTITY.PostRepository;
import com.comrade.repository.UUID.BookUUIDRepository;
import com.comrade.repository.naturalid.ProductRepository;
import com.comrade.service.EMBEDDEDandEMBEDDABLE.UserProfileService;
import com.comrade.service.ENUM.ProjectService;
import com.comrade.service.ENUM.ATTRIBUTECONVERTER.PersonENUMService;
import com.comrade.service.ENUM.ATTRIBUTECONVERTER.PhotoService;
import com.comrade.service.HASHCODEANDEQUALS.ProductEagerService;
import com.comrade.service.SYNCHRONIZEBIDIRECTIONALENTITY.PostService;
...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		//com.comrade.model.EXTRALAZYCOLLECTIONS.Post ost;
		/*

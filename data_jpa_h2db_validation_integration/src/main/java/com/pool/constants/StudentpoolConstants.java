...
public class StudentpoolConstants {
	...
	public static final String SEARCH_NO_DATA_FOUND_MESSAGE = "No Records are found with Plan Id:";
	public static final String DELETE_PLAN_MESSAGE = "Plan delete Id:";
}
